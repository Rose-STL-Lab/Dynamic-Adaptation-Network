...
from models import ModularMeta
import warnings
...
model = nn.DataParallel(ModularMeta(input_channels= input_length*2, output_channels = 2, hidden_dim = 256, kernel_size = 3, num_tasks = 20, attention = True).to(device))
